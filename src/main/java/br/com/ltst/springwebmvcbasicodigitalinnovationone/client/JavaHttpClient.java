...
public class JavaHttpClient {
    ...
    public ResultBotTelegramList buscarAtualizacao() {
        ResultBotTelegramList resultBotTelegram = null;
        ...
        try {
            resultBotTelegram = objectMapper.readValue(response.body(), ResultBotTelegramList.class);
        } catch (IOException e) {
            e.printStackTrace();
        }
    ...
    public ResultBotTelegram enviarMensagem(MessageSend msg) {
        ...
        try {
            resultBotTelegram = objectMapper.readValue(response.body(), ResultBotTelegram.class);
        } catch (IOException e) {
            e.printStackTrace();
        }
